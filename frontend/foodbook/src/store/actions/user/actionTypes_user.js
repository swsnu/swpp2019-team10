...
export const GET_USER_INFO = 'GET_USER_INFO'; // From this we can find particular user information (we need because we have to know about user's friends' information)

export const GET_FRIENDS_LIST = 'GET_FRIENDS_LIST';
// export const GET_FRIEND_INFO = 'GET_FRIEND_INFO' : It doesn't need because we are to implement GET_USER_INFO to use id.
