# Generated by Django 2.2.4 on 2019-11-27 12:07

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import django_mysql.models
import foodbook_api.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taste', django_mysql.models.JSONField(default=foodbook_api.models.my_default)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ManyToManyField(default=foodbook_api.models.default_tag, to='foodbook_api.Tag')),
            ],
        ),
        migrations.AddField(
            model_name='menu',
